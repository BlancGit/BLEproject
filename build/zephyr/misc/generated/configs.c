...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_DUMMY_PROVISIONING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_INITIAL_ATTESTATION_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_IMAGE_VERSION_S, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_IMAGE_VERSION_NS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_BL2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_IMAGE_SECURITY_COUNTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_MCUBOOT_SIGNATURE_TYPE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_KEY_FILE_S, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_KEY_FILE_NS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_MCUBOOT_IMAGE_NUMBER, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_MCUBOOT_PATH_LOCAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_ETHOS_DRIVER_PATH_LOCAL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_BL2_LOG_LEVEL_INFO, 1);
