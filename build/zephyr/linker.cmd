...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0x50000), LENGTH = (0x30000 - 0x0)
    RAM (wx) : ORIGIN = 0x20040000, LENGTH = (192 * 1K)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x0 + 0x50000);
    rom_start :
 {
HIDDEN(__rom_start_address = .);
FILL(0x00);
. += 0x400 - (. - __rom_start_address);
. = ALIGN(4);
 ...
 *(".kernel_noinit.*")
    ...
    __kernel_ram_end = 0x20040000 + (192 * 1K);
